                    ...
                    for line in enumerate(reader):
                        ...
                        for list_ in (line[1]):
                            ...
                            try:
                                ...
                                #conn.execute('INSERT INTO Good_Raw_Data values ({values})'.format(values = ('1,0,3,"Braund, Mr. Owen Harris",male,22,1,0,A/5 21171,7.25,C85,S')))
                                #conn.execute('INSERT INTO Good_Raw_Data values ({values})'.format(values = ('1,0,3,"Braund, Mr. Owen Harris",male,22,1,0,A/5 21171,7.25,C85,S')))
                                #conn.execute("INSERT INTO Good_Raw_Data(Pid,Survived,Pclass,Name,Sex,Age,SibSp,Parch,Ticket,Fare,Cabin,Embarked) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)".format(values = (line[1])))
