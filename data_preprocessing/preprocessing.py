...
class Preprocessor:
    ...
    def binning(self,data):
        ...
        self.logger_object.log(self.file_object, 'Entered into the Binning method of the Preprocessor class')
        self.data= data
        try:
            ...
            self.logger_object.log(self.file_object, 'Binning of values Successful. Exited the Binning method of the Preprocessor class')
            return self.data
        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in Binning method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Binning failed. Exited the Binning method of the Preprocessor class')
            raise Exception()
            
    
    def combiningfornewfeature(self,data):
        self.logger_object.log(self.file_object, 'Entered into the combiningfornewfeature method of the Preprocessor class')
        self.data= data
        try:
            combine = [data]
            for row in combine:
            ...
            self.logger_object.log(self.file_object, 'combiningfornewfeature  Successful. Exited the combiningfornewfeature method of the Preprocessor class')
            return self.data
            
        
            
        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in combiningfornewfeature method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Binning failed. Exited the combiningfornewfeature method of the Preprocessor class')
            raise Exception()
    
    def convertCategoricalfeatureIntonumeric(self,data):
        self.logger_object.log(self.file_object, 'Entered into the convertCategoricalfeatureIntonumeric method of the Preprocessor class')
        self.data= data
        try:
            combine = [data]
            ...
            titlemapping2 = {'male':0, 'female':1}
            for row in combine:
                row["Sex"] = row["Sex"].map(titlemapping2).astype(int)
                row['Sex'] = row['Sex'].fillna(0)
            self.logger_object.log(self.file_object, 'convertCategoricalfeatureIntonumeric  Successful. Exited the convertCategoricalfeatureIntonumeric method of the Preprocessor class')
            return self.data
            
        
            
        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in convertCategoricalfeatureIntonumeric method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Binning failed. Exited the convertCategoricalfeatureIntonumeric method of the Preprocessor class')
            raise Exception()
            
    
    def binningfare(self,data):
        
        self.logger_object.log(self.file_object, 'Entered into the binningfare method of the Preprocessor class')
        self.data= data
        try:
            data["FareBand"] = pd.cut(data["Fare"],4)
            #data[['FareBand','Survived']].groupby(['FareBand'],as_index = False).mean()
            combine2 = [data]
            ...
            #data = data.drop(['Ageband'],axis = 1)
            self.logger_object.log(self.file_object, 'binningfare of values Successful. Exited the Binning method of the Preprocessor class')
            return self.data
        except Exception as e:
            self.logger_object.log(self.file_object,'Exception occured in binningfare method of the Preprocessor class. Exception message:  ' + str(e))
            self.logger_object.log(self.file_object,'Binning failed. Exited the binningfare method of the Preprocessor class')
            raise Exception()
